...
def buildStringsAssetsConstants():
    ...
    if os.path.exists("lib/core/consts/strings_assets_constants.dart"):
        os.remove("lib/core/consts/strings_assets_constants.dart")
    # create new strings.dart file
    newFile = open("lib/core/consts/strings_assets_constants.dart", "a+")
    # open connection with the english json file
    english_strings_file = open("assets/translations/locale_en.json", "r")
...
def buildImagesAssetsConstants():
     # Remove strings.dart file
    if os.path.exists("lib/core/consts/images_assets_constants.dart"):
        os.remove("lib/core/consts/images_assets_constants.dart")
    # create new strings.dart file
    newFile = open("lib/core/consts/images_assets_constants.dart", "a+")
...
def buildIconsAssetsConstants():
    # Remove strings.dart file
    if os.path.exists("lib/core/consts/icons_assets_constants.dart"):
        os.remove("lib/core/consts/icons_assets_constants.dart")
    # create new strings.dart file
    newFile = open("lib/core/consts/icons_assets_constants.dart", "a+")
...
def buildAnimationsAssetsConstants():
    # Remove strings.dart file
    if os.path.exists("lib/core/consts/animations_assets_constants.dart"):
        os.remove("lib/core/consts/animations_assets_constants.dart")
    # create new strings.dart file
    newFile = open("lib/core/consts/animations_assets_constants.dart", "a+")
...
def buildLogosAssetsConstants():
    # Remove strings.dart file
    if os.path.exists("lib/core/consts/logos_assets_constants.dart"):
        os.remove("lib/core/consts/logos_assets_constants.dart")
    # create new strings.dart file
    newFile = open("lib/core/consts/logos_assets_constants.dart", "a+")
